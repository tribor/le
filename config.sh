...
# use test-CA if domains.txt contains 'testing=on'
grep -q "testing=on" domains.txt && CA="https://acme-staging.api.letsencrypt.org/directory" || CA="https://acme-v01.api.letsencrypt.org/directory"
grep -q "testing=on" domains.txt && echo "using CA:$CA"
...
WELLKNOWN="/tmp/.well-known/acme-challenge"
